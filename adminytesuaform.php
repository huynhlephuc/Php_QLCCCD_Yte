...
<body>
    ...
    <div class="container">
        ...
        <div class="layout__y_te">
            ...
            <form action="quanlisuaformyteaction.php?edit1=<?php echo $row['maBHYT'];?>" method="POST" class="form__layout1" data-aos="fade-left">
                <h3>Thông tin BHYT</h3>
                <div class="box1">
                    <label class="box-lable">Mã BHYT</label>
                    <input type="text" id="" name="maBHYT" value="<?php echo $maBHYT;?>"  onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Mã CCCD</label>
                    <input type="text" id="" name="idCCCD" value="<?php echo $idCCCD;?>"  onchange="uernamecheck()">
                </div>
                <div class="box1">
                ...
                <div class="box1">
                    ...
                    <input type="text" id="" name="mucHuongBHYT" value="<?php echo $mucHuongBHYT;?>"    onchange="uernamecheck()">
                </div>
