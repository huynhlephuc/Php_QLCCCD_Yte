...
<body>
    ...
    <td>
        ...
        <a href="quanliaddbenhanform.php">+ Thêm thông tin bệnh án</a>
    </td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="adminaction.php?xoa=<?php echo $row['maBHYT'];?>" class="btn btn-danger">Xóa</a>
                </td>
                -->
                ...
                <td>
                    ...
                    <a href="quanliytesuaform.php?edit1=<?php echo $row['maHoSoBenhAn'];?>" class="btn btn-danger">Sửa</a>
                </td>
            </tr>
            <?php endwhile; 
