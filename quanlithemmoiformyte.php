...
<body>
    ...
    <div class="container">
        ...
        <div class="layout__y_te">
            ...
            <form action="quanlithemmoiformyteaction.php" method="POST" class="form__layout1" data-aos="fade-left">
                <h3>Thông tin BHYt</h3>
                <div class="box1">
                    <label class="box-lable">Mã BHYT</label>
                    <input type="text" id="" name="maBHYT" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                ...
                <div class="box1">
                    ...
                    <input type="date" id="" name="ngayThamGiaBHYT" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Ngày hết hạn</label>
                    <input type="date" id="" name="ngayHetHanBHYT" placeholder="ngayHetHanBHYT" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Mức hưởng</label>
                    <input type="text" id="" name="mucHuongBHYT" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <input type="submit" class="btn" name="themyte" value="Thêm" />
            </form>
        </div>
