    ...
    <div class="container1" >
        ...
        <div class="row" >
            <div class="container1-col"  data-aos="fade-up"  >
                <h3> <a href="quanliyte.php">Quản lí thông tin bảo hiểm y tế</a></h3>
            ...
            <div class="container1-col"  data-aos="fade-up" >
                <h3><a href="quanlitainan.php">Quản lí thông tin bảo hiểm tai nạn </a></h3>
            ...
            <div class="container1-col"  data-aos="fade-up" >
                <h3><a href="quanlibenhan.php">Quản lí thông tin bệnh án</a></h3>
