...
<body>
    ...
    <td>
        ...
        <a href="adminthemtkpage.php">+ Thêm người dùng</a>
    </td>
...
<div style="width:80%;margin:0 auto;">
    <table class="table">
        <?php
            ...
            $sql="select * from tbl_taikhoan where loaiTK=0 or loaiTK=3 or loaiTK=4";
            $data=$conn->query($sql);
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="adminaction.php?delete=<?php echo $row['id_taiKhoan'];?>" class="btn btn-danger">Xóa</a>
                </td>
                <td>
                    
                    <a href="adminsuatk.php?edit=<?php echo $row['id_taiKhoan'];?>" class="btn btn-danger">Sửa</a>
                </td>
            </tr>
            <?php endwhile; 
