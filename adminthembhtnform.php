...
<body>
    ...
    <div class="container">
        ...
        <div class="layout__y_te">
            ...
            <form action="adminthembhtnformaction.php" method="POST" class="form__layout1" data-aos="fade-left">
                <h3>Thông tin BHTN</h3>
                <div class="box1">
                    <label class="box-lable">Mã BHTN</label>
                    <input type="text" id="" name="maBHTN" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                ...
                <div class="box1">
                    ...
                    <input type="date" id="" name="ngayThamGia" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Ngày hết hạn</label>
                    <input type="date" id="" name="ngayHetHan" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Mức hưởng</label>
                    <input type="text" id="" name="mucHuongBHTN" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <input type="submit" class="btn" name="themtainan" value="Thêm" />
            </form>
        </div>
