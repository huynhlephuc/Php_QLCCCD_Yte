...
<body>
    ...
    <div class="container">
        ...
        <div class="layout__y_te">
            ...
            <form action="adminqlbenhanaddformaction.php" method="POST" class="form__layout1" data-aos="fade-left">
                ...
                <input type="submit" class="btn" name="adminthembenhan" value="Thêm" />
