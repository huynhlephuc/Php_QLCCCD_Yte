...
<body>
    ...
    <td>
        ...
        <a href="adminqlbenhanaddform.php">+ Thêm thông tin bệnh án</a>
    </td>
    ...
    <table class="table">
        ...
        <thead>
            <tr>
                ...
                <th>Tiền BHYT</th>
                <th>Tiền BHTN</th>
                <th>Số tiền thực tế phải trảT</th>
                <th>Xóa</th>
                <th>Sửa</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                <td><?php echo $row['maHoSoBenhAn']?></td> 
                <td><?php echo $row['maCCCD']?></td>
                <td><?php echo $row['ngayDiKham']?></td>
                <td><?php echo $row['tenBenh']?></td>
                <td><?php echo $row['tenBenhVien']?></td>
                <td><?php echo $row['vienPhi']?></td>
                <td><?php echo $row['nhapVien']?></td>
                <td><?php echo $row['ngayNhapVien']?></td>
                <td><?php echo $row['ngayXuatVien']?></td>
                <td><?php echo $row['thuocDaLanh']?></td>
                <td><?php echo $row['tienBHYT']?></td>
                <td><?php echo $row['tienBHTN']?></td>
                <td><?php echo $row['soTienThucTePhaiTra']?></td>
                <td>
                    
                    <a href="adminaction.php?xoa=<?php echo $row['maHoSoBenhAn'];?>" class="btn btn-danger">Xóa</a>
                </td>
                
                <td>
                
                    
                    <a href="adminsuabenhanform.php?edit1=<?php echo $row['maHoSoBenhAn'];?>" class="btn btn-danger">Sửa</a>
                </td>
            </tr>
            <?php endwhile; 
