...
<body>
    ...
    <td>
        ...
        <a href="adminthemmoiformyte.php">+ Thêm thông tin BHYT</a>
    </td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="adminaction.php?xoayte=<?php echo $row['maBHYT'];?>" class="btn btn-danger">Xóa</a>
                </td>
                
                <td>
                
                    
                    <a href="adminytesuaform.php?edit1=<?php echo $row['maBHYT'];?>" class="btn btn-danger">Sửa</a>
                </td>
            </tr>
            <?php endwhile; 
