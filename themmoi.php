...
<body>
            ...
            <div class="navbar">
                <nav>
                    <ul>
                        ...
                        <li class="idex"><a href="themmoi.php">Thêm mới</a></li>
    ...
    <div class="container">
        ...
        <!-- ========THÔNG TIN LÍ LỊCH======================================================= -->
        <p id="point" data-aos="fade-down">Nhập thông tin lý lịch</p>
        <div class="layout__ly_lich">
            ...
            <form action="" class="form__layout1" data-aos="fade-right">
                ...
                <div class="box1">
                    <label class="box-lable">Nơi sinh</label>
                    <select name="" id="">
            ...
            <!-- ============FORM THÔNG TIN NƠI Ở==================== -->

            <form action="" class="form__layout1" data-aos="fade-left">
                <h3>Thông tin nguyên quán</h3>
                <div class="box1">
                    <label class="box-lable">Phường/Xã</label>
                    <select name="" id="">
                        <option value="">--Chọn--</option>
                    </select>
                </div>
                <div class="box1">
                    <label class="box-lable">Quận/Huyện</label>
                    <select name="" id="">
                        <option value="">--Chọn--</option>
                    </select>
                </div>
                <div class="box1">
                    <label class="box-lable">Tỉnh/Thành phố</label>
                    <select name="" id="">
                        <option value="">--Chọn--</option>
                    </select>
                </div>
            ...
            <!-- ============FORM THÔNG TIN CĂN CƯỚC CÔNG DÂN=============== -->
            ...
            <form action="" class="form__layout1" data-aos="fade-right">
                ...
                <div class="box1">
                    <label class="box-lable">Nơi cấp</label>
                    <select name="" id="">
            ...
            <!-- ===========FORM THÔNG TIN HỘ KHẨU================ -->

            <form action="" class="form__layout1" data-aos="fade-left">
                <h3>Thông tin hộ khẩu</h3>
                <div class="box1">
                    <label class="box-lable">Hộ khẩu số</label>
                    <input type="text" id="" name="" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Chủ hộ</label>
                    <input type="text" id="" name="" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Ngày vào</label>
                    <input type="text" id="" name="" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">QH với chủ hộ</label>
                    <select name="" id="">
                        <option value="">--Chọn--</option>
                    </select>
                </div>
                <div class="box1">
                    <label class="box-lable">Ngày chuyển</label>
                    <input type="text" id="" name="" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Nơi chuyển</label>
                    <input type="text" id="" name="" placeholder="" require="" onchange="uernamecheck()">
                </div>
            </form>

            <!-- ===========FORM ĐỊA CHỈ TẠM TRÚ================ -->

            <form action="" class="form__layout1" data-aos="fade-right">
                <h3>Thông tin địa chỉ tạm trú</h3>
                <div class="box1">
                    <label class="box-lable">Số nhà</label>
                    <input type="text" id="" name="" placeholder="" require="" onchange="uernamecheck()">
                </div>
            ...
            <form action="" class="form__layout1" data-aos="fade-left">
                ...
                <div class="box1">
                    <label class="box-lable">Dân tộc</label>
                    <select name="" id="">
                        <option value="">--Chọn--</option>
                    </select>
                </div>
                <div class="box1">
                    <label class="box-lable">Tôn giáo</label>
                    <select name="" id="">
                        <option value="">--Chọn--</option>
                    </select>
                </div>
        ...
        <div class="layout__y_te">
            ...
            <form action="" class="form__layout1" data-aos="fade-left">
                ...
                <div class="box1">
                    <label class="box-lable">Ngày khám</label>
                    <input type="date" id="" name="" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                ...
                <div class="box2">
                    ...
                    <input type="radio" class="che" name="gioitinh" id="" value="Nhập">Có
                    <input type="radio" class="che" name="gioitinh" id="" value="Không">Không
                </div>
                <div class="box1">
                    <label class="box-lable">Ngày nhập</label>
                    <input type="date" id="" name="" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Ngày xuất</label>
                    <input type="date" id="" name="" placeholder="" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
                ...
                <div class="box1">
                    ...
                    <input type="text" id="" name="" placeholder="VNĐ" require="" onchange="uernamecheck()">
                </div>
                <div class="box1">
