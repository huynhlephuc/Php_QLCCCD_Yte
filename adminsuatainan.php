...
<body>
    ...
    <div class="container">
        ...
        <!-- ========THÔNG TIN Y TẾ=================================================== -->
        <p id="point" data-aos="fade-up">Nhập thông tin bảo hiểm tai nạn</p>
        <div class="layout__y_te">
            ...
            <?php
                ...
                if(isset($_GET['edit1'])){
                $maBHTN=$_GET['edit1'];
                $sql="select * from tbl_ttbhtn where maBHTN='$maBHTN'";
                ...
                $mucHuongBHTN=$row['mucHuongBHTN'];
                $update=0;

                }?>

            <form action="adminqltainanaction.php?edit1=<?php echo $row['maBHTN'];?>" method="POST" class="form__layout1" data-aos="fade-left">
                <h3>Thông tin BHYT</h3>
                <div class="box1">
                    <label class="box-lable">Mã BHYT</label>
                    <input type="text" id="" name="maBHTN" value="<?php echo $maBHTN;?>"  onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Mã CCCD</label>
                    <input type="text" id="" name="maCCCD" value="<?php echo $maCCCD;?>"  onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Ngày tham gia</label>
                    <input type="date" id="" name="ngayThamGia" value="<?php echo $ngayThamGia;?>"   onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Ngày hết hạn</label>
                    <input type="date" id="" name="ngayHetHan" value="<?php echo $ngayHetHan;?>"   onchange="uernamecheck()">
                </div>
                <div class="box1">
                    <label class="box-lable">Mức hưởng</label>
                    <input type="text" id="" name="mucHuongBHTN" value="<?php echo $mucHuongBHTN;?>"    onchange="uernamecheck()">
                </div>
                <input type="submit" class="btn" name="suatainan" value="Sửa" />
            </form>
        </div>
