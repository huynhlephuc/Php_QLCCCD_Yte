...
<body>
    ...
    <td>
        ...
        <a href="quanlithemmoiformyte.php">+ Thêm thông tin BHYT</a>
    </td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href=".php?delete=<?php echo $row['id_taiKhoan'];?>" class="btn btn-danger">Xóa</a>
                </td>
                -->
                <td>
                
                    
                    <a href="quanliytesuaform.php?edit1=<?php echo $row['maBHYT'];?>" class="btn btn-danger">Sửa</a>
                </td>
            </tr>
            <?php endwhile; 
